...
class Form {
	...
	*/
    ...
    /**
	* Returns value if the given value is a float number
	*/
    ...
    /**
	* Returns value if the given value is a number with decimal
	*/
	...
	* Returns boolean if the given value is not blank
	*/
    private function chooseOne($value) {
        $value = trim($value);
        return $value != 'select_one' && isset($value) && !is_null($value);
    }
